# Set Environment Variables for Cafe Brain API - Final Clean Version
# This script sets all environment variables for the Azure Function App

Write-Output "Setting environment variables for Cafe Brain API..."

# Function App Environment Variables
Write-Output "Setting Function App variables..."
...
Write-Output "API URL: https://cafe-brain-api.azurewebsites.net"
Write-Output "Test the API: https://cafe-brain-api.azurewebsites.net/api/health"
